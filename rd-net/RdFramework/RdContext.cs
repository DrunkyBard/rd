...
namespace JetBrains.Rd
{
  ...
  {
    [ThreadStatic] [CanBeNull] private static SimpleObjectPool<UpdateValueCookie> ourPool;
    ...
    {
      var pool = ourPool ??= new SimpleObjectPool<UpdateValueCookie>(() => new UpdateValueCookie(), null);
